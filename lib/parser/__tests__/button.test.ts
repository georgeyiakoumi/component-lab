...
// Error handling and the happy-accident Card check live in
// `easy-bucket.test.ts` as of Pillar 2b, because after 2b landed Accordion
// now parses cleanly (Radix primitive recognition) and the set of files
// that throw is different. See that file for the parameterised coverage
// sweep and the new error-handling fixtures.
